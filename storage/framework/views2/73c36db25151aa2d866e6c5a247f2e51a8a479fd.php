            ...
            <header>
                ...
                <div class="header-list">
                    <ul>
                        ...
                        <li><a href="/en"><?php echo e(__('index.lang')); ?></a></li>
                    </ul>
                </div>
            </header>
            ...
            <div class="row">
                <div class="col-12 message-content">
                    <div class="quotation-mark right-quotation-mark">
                        <img src="<?php echo e(asset('img/quotation-mark.png')); ?>" alt=""  data-aos="zoom-in" data-aos-duration="1000">
                        <img src="<?php echo e(asset('img/quotation-mark.png')); ?>" alt=""  data-aos="zoom-in" data-aos-duration="1000">
                    </div>
                    ...
                    <div class="services">
                        <ul class="tabs">
                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="active" data-cont=".e<?php echo e($service->id); ?>">
                                    <?php echo e($service['title_' . $lang]); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 partners-logos"  data-aos="zoom-in" data-aos-duration="1000">
                    <div class="partners-logos-column column-1">
                        <?php while($index < 7): ?>
                            <?php if(isset($frindes[$index])): ?>
                                <img src="<?php echo e(Voyager::image($frindes[$index]->image)); ?>"
                                    alt="<?php echo e($frindes[$index]['name_' . $lang]); ?>">
                            <?php endif; ?>
                            <?php
                                $index++;
                            ?>
                    ...
                    <div class="partners-logos-column column-2">
                        <?php while($index < 12 and $index == 7): ?>
                            <?php if(isset($frindes[$index])): ?>
                                <img src="<?php echo e(Voyager::image($frindes[$index]->image)); ?>"
                                    alt="<?php echo e($frindes[$index]['name_' . $lang]); ?>">
                            <?php endif; ?>
                    ...
                    <div class="partners-logos-column column-3">
                        <?php while($index < 15 and $index == 12): ?>
                            <?php if(isset($frindes[$index])): ?>
                                <img src="<?php echo e(Voyager::image($frindes[$index]->image)); ?>"
                                    alt="<?php echo e($frindes[$index]['name_' . $lang]); ?>">
                            <?php endif; ?>
                ...
                <div class="col-12 col-lg-6 form-content"  data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="input-field">
                            ...
                            <option></option>
                                <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option  value="<?php echo e($service['id']); ?>"><?php echo e($service['title_' . $lang]); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\IDIX2\resources\views/welcome.blade.php ENDPATH**/ ?>