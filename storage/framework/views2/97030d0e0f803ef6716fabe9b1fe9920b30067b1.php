...
<body>
    ...
    <button id="chat_with_us" onclick="window.location.href='https://api.whatsapp.com/send?phone=966539398820'"><i class="fas fa-comment-alt"></i> <span><?php echo e(__('index.whatsapp')); ?></span></button>
...
<?php if($errors->any()): ?>
        <script src="<?php echo e(asset('js/error-message-'.LaravelLocalization::getCurrentLocale().'.js')); ?>"></script>
<?php endif; ?>
</body>
</html>
