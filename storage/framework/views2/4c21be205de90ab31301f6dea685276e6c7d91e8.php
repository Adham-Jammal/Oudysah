...
<script src="<?php echo e(asset('js/success-message-ar.js')); ?>"></script>
<?php endif; ?>



<?php if($errors->any()): ?>
        <script src="<?php echo e(asset('js/error-messag-ar.js')); ?>"></script>
<?php endif; ?>
</body>
</html>

<?php /**PATH D:\Projects\IDIX2\resources\views/app.blade.php ENDPATH**/ ?>