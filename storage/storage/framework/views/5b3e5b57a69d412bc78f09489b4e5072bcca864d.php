            ...
            <div class="row">
                <div class="col-12 message-content">
                    <div class="quotation-mark right-quotation-mark">
                        <img src="<?php echo e(asset('img/quotation-mark.png')); ?>" alt="">
                        <img src="<?php echo e(asset('img/quotation-mark.png')); ?>" alt="">
                    </div>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ali Taha\Desktop\Coding\IDIX\resources\views/welcome.blade.php ENDPATH**/ ?>